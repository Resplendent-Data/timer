...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn("text-lg font-bold leading-none tracking-[0.01em]", className)}
      {...props}
    />
  )
}
